...
| R — Reader extras | 🚧 in progress — R1 continuous (webtoon) scroll + R2 per-book overrides done (reader Settings panel; local or server storage, chosen via a setting); bookmarks pending |
